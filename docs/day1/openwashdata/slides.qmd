...
format: 
  revealjs:
    ...
    slide-number: true
    preview-links: auto
    footer: "[{{< fa link >}} openwashdata-conf.github.io/2025/day1/openwashdata.html](https://openwashdata-conf.github.io/2025/day1/openwashdata.html)"
editor: source
editor_options: 
...
## {{< fa clock >}} Detailed Timing Breakdown

| Time | Duration | Section | Key Activities |
|------|----------|---------|----------------|
| 0:00 | 3 min | Introduction & Programme | Welcome, session overview |
| 0:03 | 10 min | {{< fa chart-line >}} The Opportunity | Journal data analysis, FAIR principles |
| 0:13 | 10 min | {{< fa users >}} openwashdata & VMOST | Community intro, Vision, Mission, Objectives |
| 0:23 | 5 min | {{< fa lightbulb >}} **Activity 1** | Strategies & tactics brainstorming |
| 0:28 | 5 min | {{< fa rocket >}} Future (WP2/WP3) | Governance & expansion plans |
| 0:33 | 5 min | {{< fa graduation-cap >}} ds4owd-002 | Course plans & preparation |
| 0:38 | 2 min | {{< fa sitemap >}} Organogram | Community structure evolution |
| 0:40 | 3 min | {{< fa coins >}} Funding & Papers | Opportunities & publications |
| 0:43 | 5 min | {{< fa users >}} **Activity 2** | Funding ideas & collaborations |
| 0:48 | 2 min | {{< fa flag-checkered >}} Wrap-up | Key takeaways, next steps |

::: {.notes}
⏱️ This detailed breakdown helps you pace the session and ensures all content fits within 45 minutes
:::
...
## {{< fa lightbulb >}} Activity: Your Ideas Matter (5 minutes)
...
## {{< fa comments >}} Building on Your Ideas

::: incremental
- Your strategies from Activity 1 directly inform WP3 planning
- Local contexts you shared help shape regional initiatives
- Partnership ideas guide our collaboration approach
:::

::: {.notes}
⏱️ Callback to Activity 1 - reference specific ideas if they shared good ones
- This shows we value their input and it directly influences our work
::: 
...
## {{< fa link >}} Your Contributions Matter

From today's activities, we heard:

::: incremental
- **New strategies:** [Reference 1-2 participant ideas]
- **Funding opportunities:** [Reference specific suggestions]
- **Collaboration ideas:** [Reference partnership suggestions]
:::

**These directly shape our Phase 3 planning!**

::: {.notes}
⏱️ Callback slide - fill in with actual participant contributions during session
- This validates their input and shows immediate impact
:::
