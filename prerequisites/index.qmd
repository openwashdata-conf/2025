...
- Subscribe to the Claude Max plan ($20/month)
- Download and install Claude Code following the instructions

::: {.callout-tip}
You can cancel the subscription after the conference if you don't wish to continue using it.
:::
...
2. Type "cmd" and press Enter (or use PowerShell)
3. You should see a command prompt window
4. Type `echo Terminal works!` and press Enter
5. If you see "Terminal works!" printed, you're all set

**Alternative:** Consider installing [Windows Terminal](https://aka.ms/terminal) from the Microsoft Store for a better experience.
:::
...
You should see: `/Users/yourusername/gitrepos`
...
2. Ask in the conference Slack channel
3. Email us at [tech-support@openwashdata.org](mailto:tech-support@openwashdata.org)
