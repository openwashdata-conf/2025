...
format: 
  revealjs:
    ...
    slide-number: true
    preview-links: auto
    footer: "[{{< fa link >}} openwashdata-conf.github.io/2025/day1/governance.html](https://openwashdata-conf.github.io/2025/day1/governance.html)"
editor: source
---
...
- {{< fa pencil >}} **Activities 2-4** (15 min) - Decision making, roles, governance
:::
...
# {{< fa pencil >}} Exercises {background-color="#5b195b"}

::: {.notes}
⏱️ START: 0:55 | DURATION: 15 minutes total | END: 1:10
- Three 5-minute activities
- Apply governance concepts to participants' projects
:::
...
::: {.notes}
⏱️ START: 0:55 | DURATION: 5 minutes | END: 1:00
...
::: {.notes}
⏱️ START: 1:00 | DURATION: 5 minutes | END: 1:05
